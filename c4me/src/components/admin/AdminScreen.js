      ...
      <div className="outlet profile-container">
        ...
        <h4>Questionable Decisions</h4>
          ...
          <div className="input-field admin-button-container">
            ...
            Scrape Highschool Data
            <button type="button" onClick={this.scrapeHighschoolData} className="btn green lighten-1 z-depth-0 profile-button">Scrape Highschool data</button>
          </div>
        </form>
      </div>
    );
