...
module.exports = {
    ...
    try {
        ...
        let highschoolURL ='http://allv22.all.cs.stonybrook.edu/~stoller/cse416/niche/';
  ...
  //    for (var i = 0; i < 10; i++) {
      ...
      //  console.log("act scraped",act);
        ...
        if("scalar__value" == await page.evaluate(()=> document.querySelector('#ap-and-college-prep-courses div.profile__bucket--2 div.scalar').childNodes[1].className)){
          let ap_offered = await page.evaluate(()=> document.querySelector('#ap-and-college-prep-courses div.profile__bucket--2 div.scalar__value').innerHTML);
          hsInfo.ApOffered = parseInt(ap_offered);
        }else { hsInfo.ApOffered = "";}
