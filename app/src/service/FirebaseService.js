...
module.exports = {
    ...
    updateHs(hsInfo) {
        ...
        console.log('Updating Scraped Highschools in firebase DB...');
        Object.keys(hsInfo).forEach(function(key){
            var hsData = hsInfo[key];
           // console.log("OFFERED AP COURSES",hsData.ApOffered);
            db.collection("ScrapedHighschoolData").doc(hsData.Name).set({
                GradRate: hsData.GradRate,
                AvgACTComposite: hsData.AvgACTComposite,
                ApOffered: hsData.ApOffered,
                AvgSATEBRW: hsData.AvgSATEBRW,
                AvgSATMath: hsData.AvgSATMath,
                State: hsData.State,
                Type: hsData.Type,
                Name: hsData.Name,
                Ranking: hsData.Ranking
            });
        });
    }
